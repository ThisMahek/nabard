                                    ...
                                    <div class="card-body">
                                       ...
                                       <option value= "shg" <?=($data['vendor_details']['field_type'] == 'shg') ? 'selected' : '' ?>>SHG</option>
                                                    ...
                                                    <div class="col-xl-1 col-md-1 mb-3"  style= "margin-top:3%"  >
                                                        ...
                                                        <div class="form-group mb-3">
                                                            <label>*Name</label> 
                                                            <input type="text" required  data-check_input_field placeholder="Enter FPO Name" class="form-control form_control"   oninput="FullnameValidation(this.value,'category_name_span','submit_btn')"   name ="name" value="<?= $data['vendor_details']['name'] ?>"    id="name"  required />
                                                       ...
                                                       <div class="col-xl-6 col-md-6">
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="text" required placeholder="Enter Representative"   data-check_input_field  class="form-control form_control"  oninput="FullnameValidation(this.value,'representative_span','submit_btn')"  name ="representative" value="<?= $data['vendor_details']['representative'] ?>"  required/>
                                             ...
                                             <?php foreach ($data['vendor_bod'] as $key => $row): ?>     
                                                            <div class="row">
                                                            <input type="hidden" name="bod_hidden_id[]" value="<?= $row['id'] ?>"  data-bod_id="<?= $row['id'] ?>"   data-check_input_field>
                                                            <div class="col-xl-3 col-md-3">     
                                                                ...
                                                                <div class="col-xl-3 col-md-3">
                                                                   ...
                                                                   <div class="col-xl-3 col-md-3">
                                                                        <div class="form-group mb-3">
                                                                            <label>*Mobile No</label>
                                                                            <input type="text" required  maxlength="10"placeholder="Enter Mobile No"  data-check_input_field  value="<?= $row['bod_mobile'] ?>" name="bodmobile[]" class="form-control form_control" oninput= " return check_bod_phone(this.value,'alert_message_bod_phone<?= $row['id'] ?>',<?= $row['id'] ?>,'submit_btn')"  onkeypress="return isNumber(event)"  required/>
    ...
    $(this).parent().remove();
         ...
         <script>
            $(document).on("submit", `[data-on_submit]`, function(e) {
             ...
             $("[data-check_input_field]input[name='bod_hidden_id[]']").each(function(){
                ...
                let check_input_bodmobile = $("[data-check_input_field]input[name='bodmobile[]']");
            ...
            // console.log(bodIds[i].val());
                ...
                /*   let  bod_id = denote_div.data('bod_id');
                  alert(bod_id); */
                                 ...
                                 if (($(v).val().length == 10)) {      
                                                          $.ajax({
                                                            ...
                                                            data: {
                                                                ...
                                                                // bod_id:  check_input_bod_id,
                                                                bod_id: ($(form).data('bod_id')),
                                                                submit: 'submit',
                                                                id: id,
                                                            },
                                                            dataType: "JSON",
